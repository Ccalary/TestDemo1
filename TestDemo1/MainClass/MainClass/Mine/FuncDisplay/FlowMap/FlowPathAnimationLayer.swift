...
@objc public class FlowPathAnimationLayer: CALayer {
    /* 路线的宽度 */
    ...
    /* 路线的颜色 */
    public var lineStokeColor = UIColor("#D8E1F2") {
        didSet {
...
extension FlowPathAnimationLayer {
    /* 根据两点计算终点附近的点，用于获取圆心 */
