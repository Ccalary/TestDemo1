...
- (void)touchesMoved:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    }else if(self.center.y > ScreenHeight - (50*UIRate + self.frame.size.height/2))
    {
        self.center = CGPointMake(self.center.x, ScreenHeight - (50*UIRate + self.frame.size.height/2));
    }
